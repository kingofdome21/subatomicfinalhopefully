...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const translations = {
      ...
      electron_charge: "-1 e",
      electron_spin: "1/2",
      electron_desc: "Elektron, negatif elektrik yüküne sahip kararlı bir atomaltı parçacıktır. Atomların temel bir bileşenidir.",
      nucleus: "ÇEKİRDEK",
      proton: "PROTON",
      proton_mass: "938,3 MeV/c²",
      proton_charge: "+1 e",
      proton_spin: "1/2",
      proton_desc: "Proton, atom çekirdeğinde bulunan pozitif yüklü bir baryondur ve iki yukarı kuark ile bir aşağı kuarktan oluşur.",
      neutron: "NÖTRON",
      neutron_mass: "939,6 MeV/c²",
      neutron_charge: "0 e",
      neutron_spin: "1/2",
      neutron_desc: "Nötron, atom çekirdeğinde bulunan yüksüz bir baryondur ve bir yukarı kuark ile iki aşağı kuarktan oluşur.",
      upQuark: "YUKARI KUARK",
      upQuark_mass: "2,2 MeV/c²",
      upQuark_charge: "+2/3 e",
      upQuark_spin: "1/2",
      upQuark_desc: "Yukarı kuark, tüm kuarkların en hafifidir ve protonlar ile nötronların temel yapı taşıdır.",
      downQuark: "AŞAĞI KUARK",
      downQuark_mass: "4,7 MeV/c²",
      downQuark_charge: "-1/3 e",
      downQuark_spin: "1/2",
      downQuark_desc: "Aşağı kuark, proton ve nötronlarda bulunan temel bir parçacıktır.",
      strangeQuark: "ACAYIP KUARK",
      strangeQuark_mass: "96 MeV/c²",
      strangeQuark_charge: "-1/3 e",
      strangeQuark_spin: "1/2",
      strangeQuark_desc: "Acayip kuark, yukarı ve aşağı kuarklardan daha ağırdır ve bazı hadronların özelliklerine katkıda bulunur.",
      charmQuark: "TILSIMLI KUARK",
      charmQuark_mass: "1,28 GeV/c²",
      charmQuark_charge: "+2/3 e",
      charmQuark_spin: "1/2",
      charmQuark_desc: "Tılsımlı kuark, belirli mezon ve baryonlarda rol oynayan daha ağır bir kuarktır.",
      bottomQuark: "ALT KUARK",
      bottomQuark_mass: "4,18 GeV/c²",
      bottomQuark_charge: "-1/3 e",
      bottomQuark_spin: "1/2",
      bottomQuark_desc: "Alt kuark, üçüncü nesil kuarklardan biridir ve önemli bir kütleye sahiptir.",
      topQuark: "ÜST KUARK",
      topQuark_mass: "173 GeV/c²",
      topQuark_charge: "+2/3 e",
      topQuark_spin: "1/2",
      topQuark_desc: "Üst kuark, bilinen en ağır temel parçacıktır.",
      muon: "MÜON",
      muon_mass: "105,7 MeV/c²",
      muon_charge: "-1 e",
      muon_spin: "1/2",
      muon_desc: "Müon, elektronun daha ağır bir kuzenidir.",
      tau: "TAU",
      tau_mass: "1,777 GeV/c²",
      tau_charge: "-1 e",
      tau_spin: "1/2",
      tau_desc: "Tau, elektron ve müona benzer ağır bir lepton.",
      electronNeutrino: "ELEKTRON NÖTRINOSU",
      electronNeutrino_mass: "< 1 eV/c²",
      electronNeutrino_charge: "0 e",
      electronNeutrino_spin: "1/2",
      electronNeutrino_desc: "Elektron nötrinosu, çok hafif yüksüz bir leptondur.",
      muonNeutrino: "MÜON NÖTRINOSU",
      muonNeutrino_mass: "< 1 eV/c²",
      muonNeutrino_charge: "0 e",
      muonNeutrino_spin: "1/2",
      muonNeutrino_desc: "Müon nötrinosu, müon ile ilişkili yüksüz leptondur.",
      tauNeutrino: "TAU NÖTRINOSU",
      tauNeutrino_mass: "< 1 eV/c²",
      tauNeutrino_charge: "0 e",
      tauNeutrino_spin: "1/2",
      tauNeutrino_desc: "Tau nötrinosu, tau ile ilişkili yüksüz leptondur.",
      photon: "FOTON",
      photon_mass: "0",
      photon_charge: "0 e",
      photon_spin: "1",
      photon_desc: "Foton, elektromanyetik radyasyonun kuantumudur.",
      gluon: "GLUON",
      gluon_mass: "0",
      gluon_charge: "0 e",
      gluon_spin: "1",
      gluon_desc: "Gluon, kuarklar arasındaki güçlü kuvvetin taşıyıcısıdır.",
      wBoson: "W BOZONU",
      wBoson_mass: "80,4 GeV/c²",
      wBoson_charge: "+/- 1 e",
      wBoson_spin: "1",
      wBoson_desc: "W bozonu, zayıf nükleer kuvveti taşır.",
      zBoson: "Z BOZONU",
      zBoson_mass: "91,2 GeV/c²",
      zBoson_charge: "0 e",
      zBoson_spin: "1",
      zBoson_desc: "Z bozonu, zayıf nükleer kuvveti taşır.",
      higgsBoson: "HIGGS BOZONU",
      higgsBoson_mass: "125 GeV/c²",
      higgsBoson_charge: "0 e",
      higgsBoson_spin: "0",
      higgsBoson_desc: "Higgs bozonu, diğer parçacıklara kütle kazandırır.",
      mass: "Kütle:",
      charge: "Yük:",
      spin: "Spin:",
